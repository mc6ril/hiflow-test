import type { Paginated } from '@/shared/domain/paginated';
...
export type RecipeProgressResult = Result<RecipeProgress>;

export type RecipeProgressKey = `${number}`;

export type RecipeProgressById = Record<RecipeProgressKey, RecipeProgress>;

export type RecipeProgressByIdResult = Result<RecipeProgressById>;
